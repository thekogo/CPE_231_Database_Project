          ...
          <div class="col-span-9">
            ...
            <div class="bg-white shadow-lg rounded-md p-5 flex flex-col gap-4">
              ...
              <form @submit.prevent="submit">
                ...
                <div class="grid grid-cols-5 mb-2">
                  <label-grid for="name" value="สถานะ" />
...
export default {
  ...
  props: ["enrollments", "course", "reserve"],

  data() {
    return {
      form: this.$inertia.form({
        course_id: this.reserve.enrollment.course.id,
        start_time: new Date(this.reserve.start_time)
          .toISOString()
          .slice(0, 16),
        hours_reserved: this.reserve.hours_reserved,
        position: this.reserve.position,
  ...
  methods: {
    submit() {
      this.form.put(
        this.route("admin.reserves.update", { reserf: this.reserve.id }),
        {
          onSuccess: () => {
            Swal.fire({
              title: "Suscess",
              ...
              if (result.isConfirmed) {
                this.$inertia.get(route("admin.reserves.index"));
              }
            });
          },
        }
