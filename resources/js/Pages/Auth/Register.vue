    ...
    <jet-authentication-card register=true>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <jet-text-area id="address" type="text" class="mt-1 block w-full" v-model="form.address" required autofocus autocomplete="address" />
            </div>

            <div class="grid grid-cols-2 gap-5">
                <div>
                    <jet-label for="birthday" value="Birth Day" />
                    <jet-input id="birthday" type="date" class="mt-1 block w-full" v-model="form.birthday" required autofocus autocomplete="birthday" />
                </div>

                <div>
                    <jet-label for="phoneNumber" value="Phone Number" />
                    <jet-input id="phoneNumber" type="text" class="mt-1 block w-full" v-model="form.phoneNumber" required autofocus autocomplete="phoneNumber" />
                </div>
            </div>

            <div class="mt-4">
                <jet-label for="facebook" value="Facebook" />
                <jet-input id="facebook" type="text" class="mt-1 block w-full" v-model="form.facebook" required />
            </div>
